...
const StationeryNew = () => {
	...
	const renderForm = (
		<>
			<div>
				<Head>
					<title>Add new stationery item</title>
				</Head>
							...
							<div className="md:col-span-1">
								<div className="px-4 sm:px-0">
									<h3 className="text-lg font-medium leading-6 text-gray-900">
										Add new stationery item to a catalog
									</h3>
									<p className="mt-1 text-sm text-gray-600">
										This stationery item will be added to catalog so be careful.
										The future changes are not possible.
									</p>
								</div>
							</div>
